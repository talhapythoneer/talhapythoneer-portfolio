        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-5">
            <a
              ...
              className="text-[#737373] hover:text-[#E11D48] hover:-translate-y-0.5 transition-all duration-300"
              aria-label="GitHub"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#737373] hover:text-[#1DBF73] hover:-translate-y-0.5 transition-all duration-300"
              aria-label="Fiverr"
            >
